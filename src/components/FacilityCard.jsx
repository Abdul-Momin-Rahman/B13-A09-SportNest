...
const FacilityCard = ({ facility }) => {
    ...
    return (
        <div
            className="group rounded-3xl border border-white/10 bg-white/5 backdrop-blur transition duration-300 hover:-translate-y-2 hover:border-[#C8F04B]/30 hover:bg-[#C8F04B]/5 overflow-hidden"
        >
            ...
            <div className="relative w-full h-44 overflow-hidden">
                ...
                <span className="absolute top-3 left-3 text-xs rounded-full border border-[#C8F04B]/30 bg-[#C8F04B]/10 px-3 py-1 text-[#C8F04B] backdrop-blur">
                    {facility.facility_type}
                </span>

                
                <span className="absolute top-3 right-3 text-xs rounded-full bg-black/40 px-3 py-1 text-gray-200 backdrop-blur border border-white/10">
            ...
            <div className="p-5">
                ...
                <h3 className="text-xl font-bold group-hover:text-[#C8F04B] transition line-clamp-1">
                    {facility.name}
                </h3>

                <p className="mt-1 text-gray-400 text-sm flex items-center gap-1">
                    📍 {facility.location}
                </p>
